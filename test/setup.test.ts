...
function claudePluginCommands(options: { pluginVersion?: string } = {}) {
  ...
  return (args: string[]) => {
    ...
    if (args[1] === 'update') pluginVersion = VERSION;
...
describe('project setup', () => {
  ...
  it('updates only SameTree-managed OpenCode inbox plugins', () => {
    const repository = setup();
