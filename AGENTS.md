...
Use the SameTree MCP tools to inspect status, acknowledge policy, claim work and paths, read messages, and record handoffs. Claims are cooperative; never edit a path actively claimed by another agent.
