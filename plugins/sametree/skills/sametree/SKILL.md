...
- Record, revise, or revoke a shared instruction only with direct user authorization. Claude Code and OpenCode automatically record only prompts beginning exactly with the case-sensitive prefix `For all agents:`; ordinary prompts remain local.
